...
#include "alioth/api.h"          // IWYU pragma: keep
#include "alioth/compute/api.h"  // IWYU pragma: keep
#include "alioth/io/api.h"       // IWYU pragma: keep
#include "alioth/ipc/api.h"      // IWYU pragma: keep

#ifdef ARROW_CSV
#include "alioth/csv/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_DATASET
#include "alioth/dataset/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_FILESYSTEM
#include "alioth/filesystem/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_FLIGHT
#include "alioth/flight/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_FLIGHT_SQL
#include "alioth/flight/sql/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_JSON
#include "alioth/json/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_SUBSTRAIT
#include "alioth/engine/api.h"            // IWYU pragma: keep
#include "alioth/engine/substrait/api.h"  // IWYU pragma: keep
#endif
